...
"start" : [
   ...
   {
      "token" : "meta.type",
      "regex" : "\\b(bool|int|double|string|list|element|set|item|object|void|regex|datetime|session|window|cookie|tab|document|file|query|database|dbmanager|js-file|code-(icl|js|sql)|handle|any|type)\\b"
   },
   {
      "token" : "meta.class",
   ...
   },
   {
      ...
      "regex" : "(:)(not|alive|ignore|ajax|\\d+m?s|alt|ever|\\d+times|reverse|max\\d+|min\\d+)\\b"
   },
   {
...
"main__8" : [
   ...
   },
   {
      ...
      "regex" : "\\b(not|alive|ajax|\\d+m?s|alt|ever|\\d+times|reverse|max\\d+|min\\d+)\\b"
   },
   {
      defaultToken : "text",
   }
