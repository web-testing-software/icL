...
Each JS-Value has getter and setter, read-only values have only getter. A getter or a setter is a fragment of JavaScript code. In setter the getter value is included as \mintinline{icl}{@{value}}.
