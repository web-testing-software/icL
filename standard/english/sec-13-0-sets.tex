...
Creates a new field of data \mintinline{icl}{type}. \mintinline{icl}{values} can be an empty list just if the set is empty. The values of list will be distributed like in \mintinline{icl}{set.applicate} method.
