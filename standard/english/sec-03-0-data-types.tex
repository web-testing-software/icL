...
\item
	\mintinline{icl}{any'rValue : bool} is \true{} the object is a right value, otherwise returns \false{}.
\item
	\mintinline{icl}{any'readOnly : bool} is \true{} if the object is read-only, otherwise returns \false{}.
\item
	\mintinline{icl}{any'lValue : bool} is \true{} if the object is a left value, otherwise returns \false{};
\item
	\mintinline{icl}{any'link : bool} is \true{} if value is stored in external container and the change the value will change it externally, otherwise returns \false{}.
\end{icItems}
...
Example of method \mintinline{icl}{any.ensureRValue} using —
