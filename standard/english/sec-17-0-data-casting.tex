...
Possible exceptions: \ferror{UnrealCast}, \ferror{ParsingFailed}, \ferror{EmptyList}, \ferror{MultiList}, \ferror{IncompatibleObject}, \ferror{IncompatibleRoot} și \ferror{ComplexField} (see table \ref{errors}).
...
Possible exceptions: \ferror{ParsingFailed}, \ferror{IncompatibleRoot} și \ferror{ComplexField} (see table \ref{errors}).
...
Possible exceptions: \ferror{ParsingFailed}, \ferror{IncompatibleObject}, \ferror{IncompatibleRoot} și \ferror{ComplexField} (see table \ref{errors}).
...
Possible exceptions: \ferror{EmptyList} și \ferror{MultiList} (see table \ref{errors}).
...
Possible exceptions: \ferror{EmptySet} și \ferror{MultiSet} (see table \ref{errors}).
