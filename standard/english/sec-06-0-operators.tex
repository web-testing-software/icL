...
Returns \true{}, if string \mintinline{icl}{str} contains substring \mintinline{icl}{substr}, otherwise \false{}.
...
\mintinline{icl}{[] : list} creates an empty list.
...
\mintinline{icl}{[set ...] : set} creates union of some sets.

\mintinline{icl}{[object or set ...] : set} creates union of sets and objects.
