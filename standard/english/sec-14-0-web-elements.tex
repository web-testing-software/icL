...
Possible exceptions: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{MultiElement}, \ferror{NoSuchWindow} și \ferror{StaleElementReference} (see table \ref{errors}).
...
Possible exceptions: \ferror{NoSessions}, \ferror{EmptyElement} și \ferror{MultiElement}, \ferror{NoSuchWindow} și \ferror{StaleElementReference} (see table \ref{errors}).
...
{\bf Methodsle} clasei \mintinline{icl}{element} se împart în 2 categorii: de bază și adiționale. Methodsle de bază sunt definite pe baza de standardul W3C WebDriver. Methodsle adiționale sunt definite de standardul icL și pot fi modificate în versiunile succesive ale limbajului.
...
Possible exceptions: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{MultiElement}, \ferror{NoSuchWindow}, \ferror{InvalidElement}, \ferror{ElementNotInteractable}, \ferror{ElementClickIntercepted} și \ferror{StaleElementReference} (see table \ref{errors}).
...
Possible exceptions: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{MultiElement}, \ferror{ElementNotIntractable} \ferror{NoSuchWindow} și \ferror{StaleElementReference} (see table \ref{errors}).
