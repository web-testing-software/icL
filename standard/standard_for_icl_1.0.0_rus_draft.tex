...
Возможные исключения: \ferror{EmptyElement} и \ferror{MultipleElements}, \ferror{NoWindow} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{EmptyElement}, \ferror{MultipleElements}, \ferror{NoWindow}, \ferror{InvalidElement}, \ferror{ElementNotInteractable}, \ferror{ElementClick\-Intercepted} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{EmptyElement}, \ferror{ElementNotFound}, \ferror{MultipleElements}, \ferror{NoWindow} и \ferror{NoSuchElement}.
...
\lstinline|_tab.refresh : void| -  "Да". позволяет перезагрузить страницу.
...
Модуль баз данных определяет следующее глобальные объекты: \lstinline|_dbManager| - менеджер баз данных, \lstinline|_db| - последняя открытая база данных, \lstinline|_query| - последний запрос и \lstinline|_select| - последний select запрос.

Модуль баз данных обеспечивает следующий набор возможности:
\begin{icItems}
	\item \lstinline|_dbManager.openSQLite <strig>path : _db|;
	\item \lstinline|_db.query <_code>q : _query|;
	\item \lstinline|_db.close : void|;
	\item \lstinline|[r/w] _query'(<string>name) : any|;
	\item \lstinline|_query.set <string>field <any>value|;
	\item \lstinline|_query.exec : bool|;
	\item Доступны после выполнение:
	\begin{icItems}
		\item \lstinline|[r/o] _select'(<string>name) : any|;
		...
		\item \lstinline|_query.seek <int>pos <bool>relative = false : bool|;
	\end{icItems}
\end{icItems}

\subsubsection{\lstinline|_dbManager.openSQLite <strig>path : _db|}
\subsubsection{\lstinline|_db.query <_code>q : _query|}
\subsubsection{\lstinline|_db.close : void|}
\subsubsection{\lstinline|[r/w] _query'(<string>name) : any|}
\subsubsection{\lstinline|_query.set <string>field <any>value|}
\subsubsection{\lstinline|_query.exec : bool|}
\subsubsection{\lstinline|_query.getError : string|}
\subsubsection{\lstinline|[r/o] _select'(<string>name) : any|}
...
\subsubsection{\lstinline|_query.seek <int>pos <bool>relative = false : bool|}
