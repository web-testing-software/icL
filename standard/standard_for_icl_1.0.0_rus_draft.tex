...
Возможные ошибки: \ferror{UnrealCast}, \ferror{ParsingFailed}, \ferror{EmptyList}, \ferror{MultiList}, \ferror{IncompatibleObject}, \ferror{IncompatibleRoot} и \ferror{ComplexField}.
...
\session{} возвращает указатель на текущей сессии.
...
Объект \dom{} имеет следующие свойства:
\begin{icItems}
	\item \lstinline||;
\end{icItems}
...
Объект \files{} имеет следующие свойства:
\begin{icItems}
	\item \lstinline||;
\end{icItems}
...
Объект \make{} имеет следующие свойства:
\begin{icItems}
	\item \lstinline||;
\end{icItems}
...
Объект \logtype{} имеет следующие свойства:
\begin{icItems}
	\item \lstinline||;
\end{icItems}
...
Объект \lstinline|_import| имеет следующие свойства:
\begin{icItems}
	\item \lstinline||;
\end{icItems}
