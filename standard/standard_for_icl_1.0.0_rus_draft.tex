...
\lstdefinelanguage{icL}{
	keywords={if, else, for, filter, range, exists, while, do, any,emit, emiter, slot, @, \#, reverse, SELECT, FROM, WHERE, LIMIT, INSERT, INTO, VALUE},
	...
	classoffset=3,
	morekeywords={_icL, _log, _define, _tab, _dom, _define, _import, true, false, _numbers, _types, _key, _alert, _by, _dsv, _sessions, _session, _windows, _window, _cookies, _cookie, _tabs, _tab, _files, _file, _make, _math, _wait, _mouse, _move, _stacks, _stack, _states, _db, _query, _dbManager},
