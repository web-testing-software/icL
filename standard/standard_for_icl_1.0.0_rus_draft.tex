...
\subsubsection{\lstinline|element.query <int>by <string>selector : element| и \lstinline|_dom.query <int>by <string>selector : element|}
...
\begin{icItems}
	...
	\begin{icItems}
		...
		\item \lstinline|[r/o] element'prop-nextSibling : element [i]|;
