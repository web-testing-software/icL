...
Возможные исключения: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{MultiElement}, \ferror{NoWindow} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{MultiElement}, \ferror{NoWindow} и \ferror{NoSuch\-Element}.
...
Возможные исключения: \ferror{NoSessions}, \ferror{EmptyElement} и \ferror{MultiElement}, \ferror{NoWindow} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{NoSessions}, \ferror{InvalidArrgument}, \ferror{EmptyElement} и \ferror{Multi\-Element}, \ferror{NoWindow} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{MultiElement}, \ferror{NoWindow}, \ferror{In\-validElement}, \ferror{ElementNotInteractable}, \ferror{ElementClickIntercepted} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{ElementNotFound}, \ferror{MultiEle\-ment}, \ferror{NoWindow} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{NoSessions}, \ferror{EmptyElement}, \ferror{MultiElement}, \ferror{ElementNot\-Intractable} \ferror{NoWindow} и \ferror{NoSuchElement}.
...
Возможные исключения: \ferror{NoSessions}, \ferror{NoWindow}, \ferror{NoSuchElement}.

\subsubsection{\lstinline|element.child <int>i : element|}

Возвращает новый элемент, содержащая \code{i}-й дочерний элемент.

Возможные исключения: \ferror{NoSessions}, \ferror{NoWindow}, \ferror{NoSuchElement}, \ferror{OutOfBounds}.
