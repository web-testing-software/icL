...
Возможные исключения: \ferror{EmptyElement} и \ferror{MultipleElements} только в режиме тестирования, также \ferror{NoWindow}, \ferror{InvalidElement}, \ferror{ElementNotInteractable}, \ferror{ElementClickIntercepted} и \ferror{NoSuchElement} в любом режиме.
...
\begin{icItems}
	...
	\begin{icItems}
		...
		\item \lstinline|[r/w] element'prop-muted : bool|;
...
\code{[r/w]} - доступно для чтения и записи, \code{[r/o]} - доступно только для чтения, \code{element [c]} - коллекция, \code{element [i]} - элемент или коллекция (в зависимости от субъекта, если субъект - элемент, результат также будет элементом, если субъект - коллекция, результат также будет коллекцией). 
...
\begin{icItems}
	\item \lstinline|_sessions'length : int|;
	\item \lstinline|_sessions'(<int>i) : _session|.
\end{icItems}
...
\subsubsection{\lstinline|_sessions'length : int|}

Возвращает количество отрытых сессии.

\subsubsection{\lstinline|_sessions'(<int>i) : _session|}
...
\begin{icItems}
	\item \lstinline|_session'implicitTimeout : int|;
	\item \lstinline|_session'pageLoadTimeout : int|;
	\item \lstinline|_session'scriptTimeout : int|;
	\item \lstinline|_session'source : string|;
	\item \lstinline|_session'title : string|;
	\item \lstinline|_session'url : string|.
\end{icItems}
...
\begin{icItems}
	\item \lstinline|_window'height : int|;
	\item \lstinline|_window'width : int|;
	\item \lstinline|_window'x : int|;
	\item \lstinline|_window'y : int|.
\end{icItems}
...
Объект \cookies{} имеет следующее свойство: \lstinline|_cookies'<string>name : _cookie|. 
...
\begin{icItems}
	\item \lstinline|_cookie'domain : string|;
	\item \lstinline|_cookie'expiry : number|;
	\item \lstinline|_cookie'httpOnly : bool|;
	\item \lstinline|_cookie'name : string|;
	\item \lstinline|_cookie'path : string|;
	\item \lstinline|_cookie'secure : bool|;
	\item \lstinline|_cookie'value : string|.
\end{icItems}
...
Объект \alert{} имеет следующее свойство: \lstinline|_alert'text : string|.
...
\begin{icItems}
	\item \lstinline|_tabs'current : _tab|;
	\item \lstinline|_tabs'first : _tab|;
	\item \lstinline|_tabs'last : _tab|;
	\item \lstinline|_tabs'length : int|;
	\item \lstinline|_tabs'next : _tab|;
	\item \lstinline|_tabs'previous : _tab|;
	\item \lstinline|_tabs'(<int>i) : _tab|.
...
\begin{icItems}
	\item \lstinline|_tab'canGoBack : bool|;
	\item \lstinline|_tab'canGoForward : bool|;
	\item \lstinline|_tab'screenshot : string|;
	\item \lstinline|_tab'source : string|;
	\item \lstinline|_tab'title|;
	\item \lstinline|_tab'url|;
\end{icItems}
...
\begin{icItems}
	\item \lstinline|_file'csv : 1 [static]|;
	\item \lstinline|_file'format : int|;
	\item \lstinline|_file'none : 0 [static]|;
	\item \lstinline|_file'tsv : 2 [static]|;
	\item \lstinline|_file'valid : bool|;
\end{icItems}
...
\begin{icItems}
	\item \lstinline|_numbers'max : 4|;
	\item \lstinline|_numbers'min : 3|;
	\item \lstinline|_numbers'product : 2|;
	\item \lstinline|_numbers'process : int|;
	\item \lstinline|_numbers'sum : 1|;
\end{icItems}
...
\begin{icItems}
	\item \lstinline|_math'1divPi : double|;
	\item \lstinline|_math'1divSqrt2 : double|;
	\item \lstinline|_math'2divPi : double|;
	\item \lstinline|_math'2sqrtPi : double|;
	\item \lstinline|_math'e : double|;
	\item \lstinline|_math'ln2 : double|;
	\item \lstinline|_math'ln10 : double|;
	\item \lstinline|_math'log2e : double|;
	\item \lstinline|_math'log10e : double|;
	\item \lstinline|_math'pi : double|;
	\item \lstinline|_math'pi2 : double|;
	\item \lstinline|_math'pi4 : double|;
	\item \lstinline|_math'sqrt2 : double|;
\end{icItems}
