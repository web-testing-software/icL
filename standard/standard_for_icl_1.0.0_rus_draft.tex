...
\fancyhead[R]{\thepage{} из \pageref{LastPage}}
\fancyfoot[]{}
...
Описание класса \code{\_dbManager} -
\begin{lstlisting}[numbers=none]
...
Описание класса \code{\_sessions} -
\begin{lstlisting}[numbers=none]
...
\subsection{1\-ого ранга}

Перечень операторов 1-ого ранга -
\begin{lstlisting}[numbers=none]
...
Перечень операторов 2-ого ранга -
\begin{lstlisting}[numbers=none]
...
Перечень операторов 3-ого ранга -
\begin{lstlisting}[numbers=none]
...
Перечень операторов 4-ого ранга -
\begin{lstlisting}[numbers=none]
...
Перечень операторов 5-ого ранга -
\begin{lstlisting}[numbers=none]
...
Перечень операторов 6-ого ранга -
\begin{lstlisting}[numbers=none]
...
\subsection{7\-ого ранга}

Перечень операторов 7-ого ранга -
\begin{lstlisting}[numbers=none]
