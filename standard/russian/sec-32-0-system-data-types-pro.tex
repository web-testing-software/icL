...
\noindent Описание класса \mintinline{icl}{Alert} -
\begin{minted}{icl}
class Alert {
...
\noindent Описание класса \mintinline{icl}{By} -
\begin{minted}{icl}
class By {
...
\noindent Описание класса \mintinline{icl}{Cookie} -
\begin{minted}{icl}
class Cookie {
...
\noindent Описание класса \mintinline{icl}{Cookies} -
\begin{minted}{icl}
class Cookies {
...
\noindent Описание класса \mintinline{icl}{Datetime} -
\begin{minted}{icl}
class Datetime {
...
\noindent Описание класса \mintinline{icl}{DB} -
\begin{minted}{icl}
class DB {
	DB.query Code : Query;
	DB.close       : void;
...
\noindent Описание класса \mintinline{icl}{DBManager} -
\begin{minted}{icl}
class DBManager {
...
\noindent Описание класса \mintinline{icl}{Doc} -
\begin{minted}{icl}
class Doc {
...
\noindent Описание класса \mintinline{icl}{DSV} -
\begin{minted}{icl}
class DSV {
...
\noindent Описание класса \mintinline{icl}{File} -
\begin{minted}{icl}
class File {
    [r/o] File'CSV    : 1;
	[r/o] File'format : int;
...
\noindent Описание класса \mintinline{icl}{Files} -
\begin{minted}{icl}
class Files {
...
\noindent Описание класса \mintinline{icl}{icL} -
\begin{minted}{icl}
class icL {
...
\noindent Описание класса \mintinline{icl}{Import} -
\begin{minted}{icl}
class Import {
...
\noindent Описание класса \mintinline{icl}{Key} -
\begin{minted}{icl}
class Key {
    Key'alt   : 3;
	Key'ctrl  : 1;
...
\noindent Описание класса \mintinline{icl}{Log} -
\begin{minted}{icl}
class Log {
...
\noindent Описание класса \mintinline{icl}{Make} -
\begin{minted}{icl}
class Make {
...
\noindent Описание класса \mintinline{icl}{Math} -
\begin{minted}{icl}
class Math {
...
\noindent Описание класса \mintinline{icl}{Mouse} -
\begin{minted}{icl}
class Mouse {
    [r/o] Mouse'left   : 1;
	[r/o] Mouse'middle : 2;
...
\noindent Описание класса \mintinline{icl}{Move} -
\begin{minted}{icl}
class Move {
    [r/o] Move'bezier    : 5;
	[r/o] Move'cubic     : 4;
...
\noindent Описание класса \mintinline{icl}{Numbers} -
\begin{minted}{icl}
    [r/o] Numbers'max     : 4;
	[r/o] Numbers'min     : 3;
...
\noindent Описание класса \mintinline{icl}{Query} -
\begin{minted}{icl}
class Query {
...
\noindent Описание класса \mintinline{icl}{Session} -
\begin{minted}{icl}
class Session {
...
\noindent Описание класса \mintinline{icl}{Sessions} -
\begin{minted}{icl}
class Sessions {
...
\noindent Описание класса \mintinline{icl}{Signal} -
\begin{minted}{icl}
class Signal {
...
\noindent Описание класса \mintinline{icl}{Stack} -
\begin{minted}{icl}
class Stack {
    [r/w] Stack : value;
...
\noindent Описание класса \mintinline{icl}{Stacks} -
\begin{minted}{icl}
class Stacks {
...
\noindent Описание класса \mintinline{icl}{States} -
\begin{minted}{icl}
class States {
    States.clear    : void;
	States.delete   : void;
...
\noindent Описание класса \mintinline{icl}{Tab} -
\begin{minted}{icl}
class Tab {
...
\noindent Описание класса \mintinline{icl}{Tabs} -
\begin{minted}{icl}
class Tabs {
...
\noindent Описание класса \mintinline{icl}{Types} -
\begin{minted}{icl}
class Types {
    [r/o] Types'alert     : 10;
	[r/o] Types'bool      : 1;
...
\noindent Описание класса \mintinline{icl}{Window} -
\begin{minted}{icl}
class Window {
...
\noindent Описание класса \mintinline{icl}{Windows} -
\begin{minted}{icl}
class Windows {
