...
Метод \lstinline|link| получает в качестве селектора текст ссылки и возвращает соответствующую ссылку. Чтобы указать фрагмент текста используете \lstinline|link:fragment|, где \lstinline|fragment| - модификатор, подробное информация о модификаторах представлена в главе \ref{sec-modifiers}.

Метод \lstinline|links| получает в качестве селектора текст ссылки и возвращает все подходящие ссылки. Чтобы указать фрагмент текста используете \lstinline|links:fragment|, где \lstinline|fragment| - модификатор, подробное информация о модификаторах представлена в главе \ref{sec-modifiers}.
