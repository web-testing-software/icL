...
\subsubsection{\lstinline|DOM.query (by : int, selector : string) : element|}
...
\subsubsection{\lstinline|DOM.query (cssSelector : string) : element|}

Акроним для \lstinline|DOM.query By'cssSelector @cssSelector|.

\subsubsection{\lstinline|DOM.queryAll (by : int, selecor : string) : element|}
