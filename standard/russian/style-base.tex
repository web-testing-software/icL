...
\lstdefinelanguage{icL}{
	...
	classoffset=3,
	morekeywords={icL, Log, Tab, Doc, Import, true, false, Numbers, Types, Key, Alert, By, DSV, Sessions, Session, Windows, Window, Cookies, Cookie, Tabs, Tab, Files, File, Make, Math, Wait, Mouse, Move, Stacks, Stack, States, DB, Query, DBManager, Code, Signal},
