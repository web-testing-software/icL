...
Использование технологий \textit{crossfire.js} в скрипте приводит к переходу программы в режиме ожидания. В этом режиме программа не будет сама закрываться никогда, а будет ждать внешний вызов функций, чтобы остановить программу используете сигнал \code{Exit}.
