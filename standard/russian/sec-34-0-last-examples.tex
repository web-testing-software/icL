\begin{sourcecode}
\captionof{listing}{Example of code}
\label{test}
\begin{iclcode}
```
	Life Sport v. 1.3.0
...
parse_source = {
	...
	@trs = css:all[.HomeTable tr:not(:first-child)];

	for (@trs) {
		@obj = [=];

		@date_str = css@[td:nth-child(2)]'attr-innerText;
		@time_str = css@[td:nth-child(3)]'attr-innerText;

		@obj'datetime = parse_date (@date_str, @time_str);
		@obj'country = css@[.country-icon]'attr-innerText;
		@obj'competition = css@[td:nth-child(5)]'attr-innerText;
