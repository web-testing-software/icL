...
\mintinline{icl}{switch} получает значения \mintinline{icl}{значение}, она может иметь любой тип кроме \bool. Дальше внутри \mintinline{icl}{switch}-а имеет несколько \mintinline{icl}{case}-ов. Если значения \mintinline{icl}{case}-а — \mintinline{icl}{значениеСлучая} совпадает с \mintinline{icl}{value}, то \mintinline{icl}{case} будет выполнен.
