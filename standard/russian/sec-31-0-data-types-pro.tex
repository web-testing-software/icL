...
В данном главе представлены типы данных, которые могут быть r-значениями, l-значениями и js-значениями. Все типы отсортированы в алфавитном порядке, только первое место занимает \mintinline{icl}{value}.

\subsection{{\color{lightblue} value}}

\mintinline{icl}{value} предлагается в роли базового класса остальных типов описанных в данном главе.

\noindent Описание класса \mintinline{icl}{value} -
\begin{minted}{icl}
class value {
    value'lValue   : bool;
    value'link     : bool;
