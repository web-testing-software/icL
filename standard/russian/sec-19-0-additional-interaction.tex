...
Ожидает пока условие не станет истинной. Время ожидании: \mintinline{icl}{Session'im\- plicitTimeout} миллисекунды. 
...
Ожидает пока условие не станет истинной. Время ожидания: \mintinline{icl}{Session'implicit\- Timeout} миллисекунды. В сравнении с обычным \mintinline{icl}{wait}, тут будет передано следующие данные: \mintinline{icl}{@response} - объект с данными о завершённом запросе и \mintinline{icl}{@count} - количество активных запросов.
