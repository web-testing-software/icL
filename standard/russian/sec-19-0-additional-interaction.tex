...
Ожидает пока условие не станет истинной. Время ожидания: \code{Session'implicit\- Timeout} миллисекунды. В сравнении с обычным \code{wait}, тут будет передано следующие данные: \code{@opened} - URL новой подключения, \code{@finished} - URL завершенного запроса и \code{@count} - количество активных запросов.
