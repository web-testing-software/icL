...
\begin{icItems}
	...
	\item
	alegere selecționistă \mintinline{icl}{void % void : void}, \mintinline{icl}{void % any : any}, \mintinline{icl}{any % void : any}, \mintinline{icl}{int % int : int}, \mintinline{icl}{double % double : double}, \mintinline{icl}{string % string : list}, \mintinline{icl}{list % string : list}, \mintinline{icl}{list % list : list}, \mintinline{icl}{object % object : set}, \mintinline{icl}{set % object : set}, \mintinline{icl}{set % set : set}. Încă un operator va fi descris în capitolul \ref{webelments}.
\end{icItems}

\subsubsection{\mintinline{icl}{<void or any>arg1 | <void or any>arg2 : void or any}}
...
În cazul in care se folosește condiția implicită, se folosește următoarea sintaxă - \mintinline{icl}{exists(expression)}.
Dacă e necesar a instala o condiție proprie, sintaxa oleacă se schimbă \mintinline{icl}{exists(expression, condition)}.
