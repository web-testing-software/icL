...
\begin{icItems}
	...
	\begin{icItems}
		...
		\item \lstinline|[r/o] _move'bezier : 5| e mișcare pe curba Bezie de ordinul 3. Folosește următoarele proprietăți adiționale \code{p1x}, \code{p1y}, \code{p2x} și \code{p2y}. Dacă ele nu sunt indicate vor primi valori aleatorii din intervalul [0,0; 1,0].
	\end{icItems}
