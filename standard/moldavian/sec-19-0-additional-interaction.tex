...
Așteaptă pînă cînd condiția va returna \true. Timpul de așteptare: \mintinline{icl}{Session'implicit\- Timeout} milisecunde. 
...
Așteaptă pînă cînd condiția va returna \true. Timpul de așteptare: \mintinline{icl}{Session'implicit\- Timeout} milisecunde. În comparație cu \mintinline{icl}{wait}-ul obișnuit, aici vor fi transmise următoarele date: \mintinline{icl}{@response} - datele răspunsului serverului și \mintinline{icl}{@count} - numărul de request-uri active.
