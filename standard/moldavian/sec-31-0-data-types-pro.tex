...
În acest capitol sunt enumerate tipurile de date care pot fi valori de stînga, de dreapta și javascript. Toate tipurile sunt sortate în ordine alfabetică, numai că pe primul loc este plasată clasa \mintinline{icl}{value}.

\subsection{{\color{lightblue} value}}

\mintinline{icl}{value} se propune în rol de clasă de bază pentru restul tipurilor descrise în acest capitol.

\noindent Descrierea clasei \mintinline{icl}{value} -
\begin{minted}{icl}
class value {
    value'lValue   : bool;
    value'link     : bool;
