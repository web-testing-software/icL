...
Pentru argumentele \integer{} și \double{}, se apelează funcția \code{_numbers.process}, înainte de folosire indicați care funcție doriți să folosiți, folosind funcția \code{_numbers.setProcess} cu una din următoarele argumente: \code{_numbers'sum} - suma, \code{_numbers'product} - produs, \code{_numbers'max} - maximum, \code{_numbers'min} - minimum. După folosirea operatorului, apelați \code{_numbers .restoreProcess} ca să restaurați setările.
