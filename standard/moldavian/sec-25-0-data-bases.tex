...
\begin{icItems}
	...
	\item \mintinline{icl}{dbmanager.connect (server : string, user : string, password : string) :}\\*\mintinline{icl}{database};
	\item \mintinline{icl}{dbmanager.connect (server : string) : database};
	\item \mintinline{icl}{database.query (q : code-sql) : query};
	...
	\begin{icItems}
		...
		\item \mintinline{icl}{query.getError () : string};
...
\subsubsection{\mintinline{icl}{dbmanager.connect (server : string, user : string, password : string) :}\\*\mintinline{icl}{database}}
...
\subsubsection{\mintinline{icl}{database.query (q : code-sql) : query}}

Creează un query, pe bază de comandă SQL.

Ca să primiți o valoare de tip \mintinline{icl}{code-sql} folosiți literalul \mintinline{icl}{sql{`cod`}}. De asemenea un query poate fi creat apelînd:
\begin{icItems}
\item \mintinline{icl}{code-sql.create () : query};
\item \mintinline{icl}{code-sql.create (db : database) : query}.
\end{icItems}
