...
\noindent Descrierea clasei \code{\_alert} -
...
\noindent Descrierea clasei \code{\_by} -
\begin{lstlisting}[numbers=none]
class _by {
...
\noindent Descrierea clasei \code{\_cookie} -
\begin{lstlisting}[numbers=none]
class _cookie {
...
\noindent Descrierea clasei \code{\_cookies} -
\begin{lstlisting}[numbers=none]
class _cookies {
...
\noindent Descrierea clasei \code{\_db} -
\begin{lstlisting}[numbers=none]
class _db {
...
\noindent Descrierea clasei \code{\_dbManager} -
\begin{lstlisting}[numbers=none]
class _dbManager {
...
\noindent Descrierea clasei \code{\_dom} -
\begin{lstlisting}[numbers=none]
class _dom {
...
\noindent Descrierea clasei \code{\_dsv} -
\begin{lstlisting}[numbers=none]
class _dsv {
...
\noindent Descrierea clasei \code{\_file} -
\begin{lstlisting}[numbers=none]
class _file {
	[r/o] _file'csv    : 1;
...
\noindent Descrierea clasei \code{\_files} -
\begin{lstlisting}[numbers=none]
class _files {
...
\noindent Descrierea clasei \code{\_icL} -
\begin{lstlisting}[numbers=none]
class _icL {
...
\noindent Descrierea clasei \code{\_import} -
\begin{lstlisting}[numbers=none]
class _import {
...
\noindent Descrierea clasei \code{\_key} -
\begin{lstlisting}[numbers=none]
class _key {
	_key'alt   : 3;
	_key'ctrl  : 1;
...
\noindent Descrierea clasei \code{\_log} -
\begin{lstlisting}[numbers=none]
class _log {
...
\noindent Descrierea clasei \code{\_make} -
\begin{lstlisting}[numbers=none]
class _make {
...
\noindent Descrierea clasei \code{\_math} -
\begin{lstlisting}[numbers=none]
class _math {
...
\noindent Descrierea clasei \code{\_mouse} -
\begin{lstlisting}[numbers=none]
class _mouse {
	[r/o] _mouse'left   : 1;
	[r/o] _mouse'middle : 2;
...
\noindent Descrierea clasei \code{\_move} -
\begin{lstlisting}[numbers=none]
class _move {
	[r/o] _move'bezier    : 5;
	[r/o] _move'cubic     : 4;
...
\noindent Descrierea clasei \code{\_numbers} -
\begin{lstlisting}[numbers=none]
	[r/o] _numbers'max     : 4;
	[r/o] _numbers'min     : 3;
...
\noindent Descrierea clasei \code{\_query} -
\begin{lstlisting}[numbers=none]
class _query {
...
\noindent Descrierea clasei \code{\_session} -
\begin{lstlisting}[numbers=none]
class _session {
...
\noindent Descrierea clasei \code{\_sessions} -
\begin{lstlisting}[numbers=none]
class _sessions {
...
\noindent Descrierea clasei \code{\_signal} -
\begin{lstlisting}[numbers=none]
class _signal {
...
\noindent Descrierea clasei \code{\_stack} -
\begin{lstlisting}[numbers=none]
class _stack {
	[r/w] _stack : value;
...
\noindent Descrierea clasei \code{\_stacks} -
\begin{lstlisting}[numbers=none]
class _stacks {
...
\noindent Descrierea clasei \code{\_states} -
\begin{lstlisting}[numbers=none]
class _states {
	_states.clear    : void;
	_states.delete   : void;
...
\noindent Descrierea clasei \code{\_tab} -
\begin{lstlisting}[numbers=none]
class _tab {
...
\noindent Descrierea clasei \code{\_tabs} -
\begin{lstlisting}[numbers=none]
class _tabs {
...
\noindent Descrierea clasei \code{\_types} -
\begin{lstlisting}[numbers=none]
class _types {
	[r/o] _types'alert     : 10;
	[r/o] _types'bool      : 1;
...
\noindent Descrierea clasei \code{\_wait} -
\begin{lstlisting}[numbers=none]
class _wait {
...
\noindent Descrierea clasei \code{\_window} -
\begin{lstlisting}[numbers=none]
class _window {
...
\noindent Descrierea clasei \code{\_windows} -
\begin{lstlisting}[numbers=none]
class _windows {
