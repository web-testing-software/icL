...
Mai departe proprietățile for fi însemnate cu următoarele semne: \mintinline{icl}{[r/w]} - disponibil pentru citire și scriere, \mintinline{icl}{[r/o]} - disponibil numai pentru citire, \mintinline{icl}{[w/o]} - disponibil numai pentru scriere.
...
\begin{icItems}
\item
	\mintinline{icl}{[r/o] any'typeName : string} e numele tipului de date conținut de obiect;
\item
	\mintinline{icl}{[r/o] any'typeId : int} e identificatorul tipului de date conținut de obiect;
\item
	\mintinline{icl}{[r/o] any'rValue : bool} e egal cu \true{} dacă obiectul este o valoare de dreapta, în caz contrar \false{};
\item
	\mintinline{icl}{[r/o] any'readOnly : bool} e egal cu \true{} dacă obiectul este disponibil doar pentru citire, în caz contrar \false{};
\item
	\mintinline{icl}{[r/o] any'lValue : bool} e egal cu \true{} dacă obiectul este disponibil pentru citire și scriere, în caz contrar \false{};
\item
	\mintinline{icl}{[r/o] any'link : bool} e egal cu \true{} dacă valoare sa află într-un container extern și schimbarea valorii va schimba valoarea în mediu extern, în caz contrar \false{}.
\end{icItems}
