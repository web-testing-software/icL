...
\begin{icItems}
	...
	\item \mintinline{icl}{document.type (text : string) : document}.
\end{icItems}
...
\subsubsection{\mintinline{icl}{document.type (text : string) : element}}
...
\begin{icItems}
	...
	\item \mintinline{icl}{element.superClick () : element};
	\item \mintinline{icl}{document.click (data : object) : document};
	\item \mintinline{icl}{document.hover (data : object) : document};
	\item \mintinline{icl}{document.mouseDown (data : object) : document};
	\item \mintinline{icl}{document.mouseUp (data : object) : document}.
\end{icItems}
...
\subsubsection{\mintinline{icl}{element.superClick () : element}}

Simulează un click pe element chiar dacă nu este vizibil.

\subsubsection{\mintinline{icl}{document.click (data : object) : document}}

Simulează un click pe document.

\subsubsection{\mintinline{icl}{document.hover (data : object) : document}}

Simulează mutarea mouse-ului pe document.

\subsubsection{\mintinline{icl}{document.mouseDown (data : object) : document}}

Simulează apăsarea butonului mouse-ului pe document.

\subsubsection{\mintinline{icl}{document.mouseUp (data : object) : document}}
