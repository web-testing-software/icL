...
Elementul se numește unic dacă este creat de funcția \lstinline|DOM.query| sau \lstinline|element.query|. Elementul se numește colecție dacă este creat de funcția \lstinline|DOM.queryAll| sau \lstinline|element.queryAll|. Extragerea elementului după index returnează element unic. 
...
Acronim pentru \lstinline|element.query By'cssSelector @cssSelector|; 
...
Acronim pentru \lstinline|element.queryAll By'cssSelector @cssSelector|;
...
Returnează un șir de caractere, care conține captura elementului, codată în base64. Captura poate fi salvată ca imagine cu \lstinline|Make.image <string>base64 <string>path : void|.
