...
Elementele web pot fi declarate prin literalul \lstinline|method@target[selector]|, unde \lstinline|method| e unul din următoarele cuvinte: \lstinline|css|, \lstinline|xpath|, \lstinline|link|, \lstinline|links|, \lstinline|tag|, \lstinline|tags|. \lstinline|@target| e o variabilă locală, care conține un element web. \lstinline|selector| e un selector, un șir de caractere, după care se definește, care elemente vor fi capturate, fiecare metodă trebuiește un selector aparte.

Metoda \lstinline|css| primește în calitate de selector un selector CSS. Acestă metodă va returna primul element compatibil. Pentru a obține toate elemente folosiți \lstinline|css:all|, unde \lstinline|all| este un modificator, mai multa informație despre modificatori, puteți găsi în capitolul \ref{sec-modifiers}.

Metoda \lstinline|xpath| primește în calitate de selector o cale XPath. Acestă metodă va returna primul element compatibil. Pentru a obține toate elemente folosiți \lstinline|xpath:all|, unde \lstinline|all| este un modificator, mai multa informație despre modificatori, puteți găsi în capitolul \ref{sec-modifiers}.

Metoda \lstinline|link| primește în calitate de selector textul linkului și returnează linkul corespunzător. Pentru a indica un fragment de text folosiți \lstinline|link:fragment|, unde \lstinline|fragment| este un modificator, mai multa informație despre modificatori, puteți găsi în capitolul \ref{sec-modifiers}.

Metoda \lstinline|links| primește în calitate de selector un text și returnează toate linkurile, care conțin exact acest text. Pentru a indica un fragment de text folosiți \lstinline|links:fragment|, unde \lstinline|fragment| este un modificator, mai multa informație despre modificatori, puteți găsi în capitolul \ref{sec-modifiers}.

Metoda \lstinline|tag| primește în calitate de selector un nume de tag și returnează primul element al tagului corespunzător.

Metoda \lstinline|tags| primește în calitate de selector un nume de tag și returnează toate elemente tag-ului corespunzător.
...
În contextul elementelor web apare un operator nou: \lstinline|[element ...] : element|;
