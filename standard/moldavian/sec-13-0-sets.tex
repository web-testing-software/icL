...
\item \mintinline{icl}{set.insertField (name : string, value : list, type = string) : set};
\item \mintinline{icl}{set.insertField (name : string, value : any, type = void) : set};
...
\subsubsection{\mintinline{icl}{set.insertField (name : string, value : list, type = string) : set}}
...
\subsubsection{\mintinline{icl}{set.insertField (name : string, value : any, type = void) : set}}
