...
Și următoarele metode:
\begin{icItems}
	\item \mintinline{icl}{tab.back () : tab};
	\item \mintinline{icl}{tab.close () : void};
	\item \mintinline{icl}{tab.focus () : tab};
	\item \mintinline{icl}{tab.forward () : tab};
	\item \mintinline{icl}{tab.get (url : string) : bool};
	\item \mintinline{icl}{tab.load (url : string) : tab}.
\end{icItems}
...
\subsubsection{\mintinline{icl}{tab.back () : tab}}
...
\subsubsection{\mintinline{icl}{tab.focus () : tab}}

Schimbă focusul la tab. Focusul se schimbă între taburile din sesiune.

Excepții posibile: \ferror{NoSessions} (pr. tab. \ref{errors}).

\subsubsection{\mintinline{icl}{tab.forward () : tab}}
...
\subsubsection{\mintinline{icl}{tab.load (url : string) : tab}}
