...
\mintinline{icl}{[icL]} Comanda \mintinline{icl}{$run} primește numai un argument - cod, în cod pot fi prezente variabile icL. Variabilele globale pot fi transmise în modul următor \mintinline{icl}{#{nume}}, localele - \mintinline{icl}{@{nume}}. Exemplu de transmitere al valorilor în JavaScript este demonstrat pe foaia \ref{jsrunex1}. Codul se poate de executat asincron folosind comanda \mintinline{icl}{$runAsync}.
