...
Amintesc că modificatorii se descriu prin următoarea sintaxă - \mintinline{icl}{control:modifier}. De asemenea modificatorii pot fi mai mulți, sintaxă - \mintinline{icl}{control:[min2,max3]}. Folosirea în pereche a modificatorilor incompatibili va opri imediat programul.
...
Literalele elementelor web primesc numai un modificator, în acord cu metodologia {\it errorless} literalele pot accepta următoarii modificatori (disponibil numai pentru metodele \mintinline{icl}{css}, \mintinline{icl}{xpath}, \mintinline{icl}{link}, \mintinline{icl}{tag}, \mintinline{icl}{button}, \mintinline{icl}{input}, \mintinline{icl}{field}, \mintinline{icl}{h1}, \mintinline{icl}{h2}, \mintinline{icl}{h3}, \mintinline{icl}{h4}, \mintinline{icl}{h5}, \mintinline{icl}{h6}, \mintinline{icl}{legend} și \mintinline{icl}{span}):
\begin{icItems}
	\item \mintinline{icl}{:try} returnează o colecție deșartă dacă nu s-a primit de găsit elementul;
	\item \mintinline{icl}{:tryXs} caută elementul timp de X secunde, apoi returnează o colecție deșartă;
	\item \mintinline{icl}{:tryXms} caută elementul timp de X milisecunde, apoi returnează o colecție deșartă;
	\item  \mintinline{icl}{:waitXs} așteaptă X secunde, apoi generează o excepţie;
	\item \mintinline{icl}{:waitXms} așteaptă X milisecunde, apoi generează o excepție.
\end{icItems}
