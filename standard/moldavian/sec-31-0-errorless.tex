...
\begin{icItems}
	\mintinline{icl}{:try} returnează o colecție deșartă dacă nu s-a primit de găsit elementul;
	\mintinline{icl}{:tryXs} caută elementul timp de X secunde, apoi returnează o colecție deșartă;
	\mintinline{icl}{:tryXms} caută elementul timp de X milisecunde, apoi returnează o colecție deșartă;
	\mintinline{icl}{:waitXs} așteaptă X secunde, apoi generează o excepţie;
	\mintinline{icl}{:waitXms} așteaptă X milisecunde, apoi generează o excepție.
\end{icItems}
