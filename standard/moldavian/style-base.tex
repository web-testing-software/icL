...
\lstdefinelanguage{icL}{
	keywords={if, else, for, filter, range, exists, while, do, any,emit, emiter, slot, assert, listen, @, \#, class, extends, reverse, jammer, SELECT, FROM, WHERE, LIMIT, INSERT, INTO, VALUE},
