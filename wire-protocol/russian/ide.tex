...
Принимает только параметр \jsinline{name} - название сессий.
...
Принимает параметр \jsinline{id} - идентификатор сессий.
...
\begin{icItems}
	\item \jsinline{name} - название проекта;
...
Принимает параметр \jsinline{id} - идентификатор проекта.
...
Принимает параметр \jsinline{id} - идентификатор сессии.
...
Имеет параметр \jsinline{path} - полный путь файла на сервере.
...
Принимает параметр \jsinline{project} - идентификатор проекта.

\subsubsection{\jsinline{cancel-transaction}}

Отменяет транзакцию. Принимает параметр \jsinline{project} - идентификатор проекта.
...
Получает аргумент \jsinline{project} - идентификатор проекта.
